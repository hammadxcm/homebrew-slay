class SlayPort < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/hammadxcm/slay/releases/download/v0.2.2/slay-darwin-arm64"
      sha256 "30325dfb075ec70fc9d8aee411999927d7d2dfb0be610dda4e060980b37f7562"
    else
      url "https://github.com/hammadxcm/slay/releases/download/v0.2.2/slay-darwin-x64"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/hammadxcm/slay/releases/download/v0.2.2/slay-linux-arm64"
      sha256 "a8ee0c9b3486d021a5b882a812c93e03be16bcd7be64eb0f27f306ee54570a01"
    else
      url "https://github.com/hammadxcm/slay/releases/download/v0.2.2/slay-linux-x64"
