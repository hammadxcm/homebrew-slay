class SlayPort < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/hammadxcm/slay/releases/download/v0.1.3/slay-darwin-arm64"
      sha256 "2c0fbbfe54e912ed33e4b9ea7b337e29ec29e3672bbb997f167bd35ebe5ca6db"
    else
      url "https://github.com/hammadxcm/slay/releases/download/v0.1.3/slay-darwin-x64"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/hammadxcm/slay/releases/download/v0.1.3/slay-linux-arm64"
      sha256 "1838729949284ee7bbd644aa0fcb76914b2502eb8d9d899609c4ad17a8e0b796"
    else
      url "https://github.com/hammadxcm/slay/releases/download/v0.1.3/slay-linux-x64"
